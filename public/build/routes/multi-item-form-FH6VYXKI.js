import {
  require_react_dom
} from "/build/_shared/chunk-F2CI6DMC.js";
import {
  Form,
  React,
  __commonJS,
  ...
  useLoaderData,
  useSubmit
} from "/build/_shared/chunk-MBFTLOVJ.js";
...
// browser-route-module:/Users/markjensen/Code/jds-client-projects/2022/remixed-form/app/routes/multi-item-form.tsx?browser
init_react();
...
function Tree2Element(tree) {
  return tree && tree.map(function(node2, i) {
    return import_react11.default.createElement(node2.tag, __assign2({
      key: i
...
function GenIcon(data) {
  return function(props) {
    return import_react11.default.createElement(IconBase, __assign2({
...
function IconBase(props) {
  var elem = function(conf) {
    ...
    return import_react11.default.createElement("svg", __assign2({
      stroke: "currentColor",
      fill: "currentColor",
      strokeWidth: "0"
...
function FormField({
  ...
  let [fieldErrors, setFieldErrors] = (0, import_react12.useState)(errors);
  let [fieldVisited, setFieldVisited] = (0, import_react12.useState)(visited);
  function onChange(e) {
...
function useExpandableList({ field }) {
  ...
  const [selectedIndex, setSelectedIndex] = (0, import_react12.useState)(void 0);
  const [selectedAction, setSelectedAction] = (0, import_react12.useState)("");
  const [listItems, setListItems] = (0, import_react12.useState)([]);
  ...
  function ExpandableList({ context }) {
    ...
    }, /* @__PURE__ */ React.createElement(FiPlusCircle, null)), field.addItemLabel), /* @__PURE__ */ React.createElement("span", {
...
function useStatefulRadio({
  ...
  const [selectedValue, setSelectedValue] = (0, import_react12.useState)(selectedIndex);
...
function MultiItemForm() {
  ...
  let formStructure = data == null ? void 0 : data.formStructure;
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", {
 ...
 */
//# sourceMappingURL=/build/routes/multi-item-form-FH6VYXKI.js.map
