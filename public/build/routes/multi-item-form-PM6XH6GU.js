import {
  require_react_dom
} from "/build/_shared/chunk-HX5PKT7A.js";
import {
  Form,
  React,
  __commonJS,
...
var styles_default = "/build/_assets/styles-B6PX2QB7.css";
...
function displayFieldErrors({
  ...
  let errorTest = ["Something very bad just happened"];
  return /* @__PURE__ */ React.createElement("div", {
    className: "mb-1"
  }, true ? fieldErrors.map((fieldError) => {
    return /* @__PURE__ */ React.createElement("div", {
...
function ExpandableList({
  ...
  }, /* @__PURE__ */ React.createElement(FiPlusCircle, null)), fieldBlueprint.addItemLabel), /* @__PURE__ */ React.createElement("span", {
...
function FormField({
  ...
  if (field.type === "expandable-list") {
    return /* @__PURE__ */ React.createElement(ExpandableList, {
      fieldBlueprint: field,
      fieldContext: context[field.name]
    });
  }
  if (field.type === "stateful-radio") {
    return /* @__PURE__ */ React.createElement(StatefulRadio, {
      fieldBlueprint: field,
      context
    });
  }
 ...
 */
//# sourceMappingURL=/build/routes/multi-item-form-PM6XH6GU.js.map
